...
export class MeshReflectorMaterial extends MeshStandardMaterial {
	...
	gl_Position = projectionMatrix * modelViewMatrix * vec4(pos, 1.0);`
      ...
      vec4 new_vUv = my_vUv;
      vec4 final_vUv = my_vUv-my_vUv/2.0;
...
float b = (sin(final_vUv.x+final_vUv.y)+cos(final_vUv.x+final_vUv.y))/2.8+1.1;
      ...
      newMerge.r = (merge.r - 2.5) * mixContrast + 1.;
      newMerge.g = (merge.g - 1.5) * mixContrast + 1.;
      newMerge.b = (merge.b - 1.8) * mixContrast - 0.7;
